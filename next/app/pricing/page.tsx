      ...
      <div className="container mx-auto px-4 max-w-6xl py-10 md:py-16">
        <div>
          ...
          <div className="bg-white/40 backdrop-blur-sm rounded-[2.5rem] p-4 md:p-10 border border-white/60 shadow-sm">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="group relative bg-[#F8F9FA] rounded-3xl border border-gray-100 overflow-hidden flex flex-col transition-all duration-300 hover:shadow-xl hover:shadow-gray-100">
                <div className="p-8 border-b border-gray-100">
                  <div className="flex justify-between items-start mb-6">
                    <div className="w-12 h-12 rounded-xl bg-slate-400 flex items-center justify-center text-white">
                  ...
                  <h2 className="text-[24px] leading-[32px] font-bold text-black mb-2">Free Plan</h2>
                  <div className="flex items-baseline gap-2">
                    <span className="text-[40px] leading-[48px] font-black text-black">R0</span>
                    <span className="text-[10px] leading-[15px] font-normal text-black opacity-40 uppercase tracking-widest">/ Always</span>
                  </div>
                </div>

                <div className="p-8 flex-grow bg-white flex flex-col justify-between">
                  ...
                  <Button
                    ...
                    size="xl"
                    className={cn(
                      "w-full uppercase tracking-widest font-black text-[10px]",
                      session 
              ...
              <div className="relative bg-[#F8F9FA] rounded-3xl border border-gray-100 overflow-hidden flex flex-col transition-all duration-300 hover:shadow-xl hover:shadow-gray-100">
                <div className="p-8 border-b border-gray-100">
                  ...
                  <h2 className="text-[24px] leading-[32px] font-bold text-black mb-2">Credits Booster Pack</h2>
                  <div className="flex items-baseline gap-2">
                ...
                <div className="p-8 flex-grow bg-white">
                  <ul className="space-y-6 mb-10">
                    {[
                      { text: "100 Credits", icon: Zap, color: "text-blue-400" },
                      { text: "Generate Daily, 3-days or Weekly AI reports", icon: ArrowRight, color: "text-blue-400" },
                      { text: "Share reports with your crew via WhatsApp", icon: Check, color: "text-blue-400" },
                      { text: "30 points bank balance grants access to view Raid Logs & AI reports", icon: Check, color: "text-blue-400" },
            ...
            <div className="mt-16 bg-gradient-to-br from-indigo-50/50 to-blue-50/50 rounded-[2.5rem] p-8 md:p-12 border border-indigo-100 shadow-sm">
              <div className="flex flex-col gap-10">
                <div className="space-y-4 max-w-3xl">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-white border border-indigo-100 text-indigo-700 text-[10px] font-black uppercase tracking-widest">
                    <Sparkles className="w-3.5 h-3.5 animate-pulse" /> Points Economy
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                  <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex gap-4 transition-all hover:shadow-md">
                    <div className="w-8 h-8 rounded-lg bg-green-50 flex items-center justify-center shrink-0 text-green-600 border border-green-100">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 font-medium leading-normal">
                        Earn <span className="font-bold text-green-600">+30 Points</span> for every surf session you log or for each friend who joins using your squad recruitment link below.
                      </p>
                    </div>
                  </div>
                  <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex gap-4 transition-all hover:shadow-md">
                    <div className="w-8 h-8 rounded-lg bg-indigo-50 flex items-center justify-center shrink-0 text-indigo-600 border border-indigo-100">
                      <CreditCard className="w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="text-[12px] font-black uppercase tracking-widest text-gray-900 mb-1">2. Buy Credits (Paid)</h4>
                      <p className="text-xs text-gray-500 font-medium leading-normal">
                        Refill instantly with our <span className="font-bold text-indigo-600">Credits Booster Pack</span> (100 credits for R100) or subscribe to get monthly credit bundles.
                      </p>
                    </div>
                  </div>
                </div>
