...
export function getScoreDisplay(score: number): ScoreDisplay {
  ...
  if (s >= 4.75) return { description: "Yeeeew!", emoji: "🤩🔥", stars: "⭐".repeat(5) };
  if (s >= 4.25) return { description: "Possibly fire", emoji: "🔥", stars: "⭐".repeat(4) };
  if (s >= 3.75) return { description: "Possibly good", emoji: "🏄‍♂️", stars: "⭐".repeat(4) };
  if (s >= 3.25) return { description: "Scrappy", emoji: "🤙", stars: "⭐".repeat(3) };
