...
import { CATEGORY_COLORS as categoryColors, SOURCE_COLORS as sourceColors } from "@/app/constants/colors";
        ...
        <div className="px-3 py-3">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-8 gap-2">
              <Loader2 className="w-5 h-5 animate-spin text-brand-blue-primary" />
                  ...
                  <li key={report.id}>
                    <button
                      ...
                      className={cn(
                        ...
                        "hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-50/60",
                        "hover:shadow-sm",
                      )}
                    >
                      {/* Index / glow dot */}
                      <div className="shrink-0 w-5 h-5 rounded-full bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
                        <span className="text-[9px] font-black text-brand-blue-dark leading-none">
                          {idx + 1}
                        </span>
                      </div>
                                ...
                                <div className="flex items-center gap-1 ml-0.5">
                                  ...
                                  {user.link && (
                                    <a 
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="hover:text-brand-blue-primary transition-colors p-0.5"
                                      title="Website"
                                    >
                      ...
                      <ArrowRight
                        className={cn(
                          ...
                          "group-hover:text-brand-blue-primary group-hover:translate-x-0.5",
                        )}
                      />
                    </button>
                  </li>
