...
// NOTE: This file is copied to backend/src/data/beachData.ts
// The import path is changed to: import { Beach } from "../types/beaches";
...
export const beachData: Beach[] = [
  {
    ...
    distanceFromCT: 0,
    optimalWindDirections: ["SE", "E", "ESE"],
    ...
    bestSeasons: ["dry"],
    optimalTide: "ALL",
    description: "The crown jewel of Balinese surfing. A series of world-class lefts that can handle massive swells.",
    difficulty: "ADVANCED",
    ...
    hazards: ["Sharp reef", "Currents", "Huge crowds"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
    image: "https://images.unsplash.com/photo-1544910919-a403f5963952?q=80&w=2620&auto=format&fit=crop",
    coordinates: {
      lat: -8.825,
      lng: 115.084,
    },
  },
  {
    ...
    description: "The 'Indonesian Pipeline'. A heavy, hollow left-hand barrel over a shallow reef.",
    difficulty: "EXPERT",
    waveType: "REEF_BREAK",
    swellSize: {
      min: 1.2,
    ...
    hazards: ["Extremely shallow reef", "Crowds"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
    image: "https://images.unsplash.com/photo-1519046904884-53103b34b206?q=80&w=2620&auto=format&fit=crop",
    coordinates: {
      lat: -8.815,
      lng: 115.103,
    },
  },
  {
    ...
    bestSeasons: ["dry"],
    optimalTide: "MID",
    description: "A mechanical, hollow left-hand barrel that is incredibly consistent.",
    difficulty: "ADVANCED",
    waveType: "REEF_BREAK",
    swellSize: {
      min: 0.9,
    ...
    hazards: ["Shallow reef", "Intense crowds"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
  ...
  },
  {
    ...
    bestSeasons: ["dry"],
    optimalTide: "ALL",
    description: "A mellow, rolling wave perfect for longboarders and beginners.",
    difficulty: "BEGINNER",
    ...
    hazards: ["Extreme crowds", "Beginners"],
    crimeLevel: "Medium",
    sharkAttack: {
      hasAttack: false,
    },
    image: "https://images.unsplash.com/photo-1537519646099-335112f03225?q=80&w=2620&auto=format&fit=crop",
    coordinates: {
      lat: -8.654,
      lng: 115.127,
    },
  },
  {
    ...
    bestSeasons: ["wet"],
    optimalTide: "MID_TO_HIGH",
    description: "A high-performance right-hand reef break, famous for being on the world tour.",
    difficulty: "ADVANCED",
    waveType: "REEF_BREAK",
    swellSize: {
      min: 0.9,
    ...
    hazards: ["Sharp reef", "Powerful wave"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
    image: "https://images.unsplash.com/photo-1502680390469-be75c86b636f?q=80&w=2620&auto=format&fit=crop",
    coordinates: {
      lat: -8.589,
      lng: 115.344,
    },
  },
  {
    ...
    bestSeasons: ["dry"],
    optimalTide: "MID",
    description: "Bali's longest left-hand point break. Mellow and fun for intermediate surfers.",
  ...
  {
    id: "brandfontein-private-nature-reserve",
    name: "Brandfontein Private Nature Reserve",
    continent: "Africa",
    countryId: "za",
    regionId: "western-cape",
    location: "Brandfontein",
    isHiddenGem: true,
    distanceFromCT: 200,
    ...
    optimalTide: "ALL",
    description:
      "Hidden gem in a private nature reserve. Works best with S to SW swell and N to NE winds. Requires minimum 1.6m swell to break properly.",
    difficulty: "INTERMEDIATE",
    waveType: "BEACH_BREAK",
    swellSize: {
      min: 1.6,
    ...
    hazards: ["Remote location", "Private property access required"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
  ...
  {
    id: "hik-abalone-farm",
    name: "HIK Abalone Farm",
    continent: "Africa",
    countryId: "za",
    regionId: "western-cape",
    location: "HIK Abalone Farm",
    isHiddenGem: true,
    distanceFromCT: 200,
    optimalWindDirections: ["N", "NE"],
    optimalSwellDirections: {
    ...
    optimalTide: "ALL",
    description:
      "Hidden gem at HIK Abalone Farm. Works best with S to SW swell and N to NE winds.",
    difficulty: "INTERMEDIATE",
    waveType: "BEACH_BREAK",
    swellSize: {
      min: 1.6,
  ...
  },
  {
    ...
    optimalTide: "ALL",
    description:
      "Hidden gem in Walker Bay Nature Reserve. Works best with SW to W swell and NE to E winds. 17km stretch of pristine white sandy beach.",
    difficulty: "INTERMEDIATE",
    waveType: "BEACH_BREAK",
    swellSize: {
      min: 1.6,
    ...
    hazards: ["Remote location", "Protected nature reserve"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
  ...
  },
  {
    ...
    name: "Skeleton Bay",
    continent: "Africa",
    countryId: "na", // Changed from South Africa to Namibia
    regionId: "swakopmund",
...

  {
    ...
    name: "Plage du Dahu",
    continent: "Africa",
    countryId: "ga", // Based on location and characteristics similar to other Gabon spots
    regionId: "gabon-coast",
    location: "Gabon Coast",
    distanceFromCT: 3500, // Approximate distance from Cape Town
    optimalWindDirections: ["ENE"],
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "MID",
    description: "World-class right-hand point break over reef. Known for its powerful barrels and long, high-performance sections. Best in winter South swells.",
    difficulty: "ADVANCED",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 1,
    ...
    hazards: ["Sharp reef", "Currents", "Remote location"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
    image: "https://images.unsplash.com/photo-1534067783941-51c9c23ecefd?w=600&auto=format&fit=crop&q=60",
    coordinates: {
      lat: -23.8631,
      lng: 35.5483,
    },
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "LOW_TO_MID",
    description: "Legendary long right-hand point break. Peels for hundreds of meters over sand. Excellent for both surfing and foiling the long walls.",
    difficulty: "INTERMEDIATE",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 0.9,
    ...
    hazards: ["Currents", "Crowds"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
    image: "https://images.unsplash.com/photo-1516108317508-6788f6a160e6?w=600&auto=format&fit=crop&q=60",
    coordinates: {
      lat: -26.8458,
      lng: 32.8885,
    },
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "ALL",
    description: "Remote headland with a long, barrelling right-hand point break. The combination of ocean-side point and massive estuary makes it an adventurous dream for surfing and foiling.",
    difficulty: "ADVANCED",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 1,
    ...
    hazards: ["Remote location", "Sharks", "Currents"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "ALL",
    description: "Legendary left point break, known as the world's longest left. Features multiple sections combining beach reef and point break characteristics. Works best with SSW groundswells and ENE offshore winds.",
    difficulty: "INTERMEDIATE",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 1.4,
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "ALL",
    description: "World Surfing Reserve famous for its consistent long lefts. Ideal for longboarding with multiple mellow sections. Historic site for traditional reed boats.",
    difficulty: "BEGINNER",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 0.9,
    ...
    image: "https://images.unsplash.com/photo-1544910919-a403f5963952?w=600&auto=format&fit=crop&q=60",
    coordinates: {
      lat: -8.1167,
      lng: -79.1167,
    },
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "ALL",
    description: "One of the longest left-hand point breaks in the world. Can connect for over a kilometer. Excellent for longboarding on medium swells.",
    difficulty: "INTERMEDIATE",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 1.2,
    ...
    image: "https://images.unsplash.com/photo-1519046904884-53103b34b206?w=600&auto=format&fit=crop&q=60",
    coordinates: {
      lat: -7.4006,
      lng: -79.5714,
    },
  ...
  {
    id: "pichilemu-la-puntilla",
    name: "Pichilemu - La Puntilla",
    continent: "South America",
    countryId: "cl",
    regionId: "chicama",
    location: "Pichilemu",
    ...
    bestSeasons: ["summer"],
    optimalTide: "LOW",
    description: "La Puntilla is the town's premier longboarding spot, offering long, peeling left-handers that mellow out into the bay.",
    difficulty: "INTERMEDIATE",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 1,
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "ALL",
    description: "A powerful, world-class left-hand point break. Its long walls are excellent for high-performance longboarding when conditions are right.",
    difficulty: "ADVANCED",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 1.2,
    ...
    hazards: ["Powerful waves", "Crowds"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
    image: "https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=600&auto=format&fit=crop&q=60",
    coordinates: {
      lat: -22.9248,
      lng: -42.4851,
    },
  ...
  },
  {
    ...
    countryId: "cameroon",
    regionId: "sud",
    location: "Lobe River Mouth",
    distanceFromCT: 4800,
    optimalWindDirections: ["NE", "E", "N"],
    optimalSwellDirections: {
      min: 180,
      max: 220,
      cardinal: "S-SW",
    ...
    bestSeasons: ["summer", "winter"],
    optimalTide: "ALL",
    description: "A tropical surf destination featuring beach breaks and a point break near the mouth of the Lobé River, where surfers can ride waves directly alongside the famous Lobé Waterfalls as they cascade straight into the Atlantic Ocean.",
    difficulty: "INTERMEDIATE",
    waveType: "BEACH_BREAK",
    swellSize: {
      min: 0.6,
    ...
    hazards: ["Rocks", "Strong river currents"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
  ...
  },
  {
    ...
    location: "Luderitz",
    distanceFromCT: 1100,
    optimalWindDirections: ["E", "SE", "ESE"],
    optimalSwellDirections: {
      min: 180,
      max: 240,
      cardinal: "S-SW",
    ...
    bestSeasons: ["winter"],
    optimalTide: "MID",
    description: "A freezing, wind-swept hidden gem that requires massive South Atlantic groundswells to break, producing heavy, powerful waves over deep, kelp-covered rocky reefs.",
    difficulty: "ADVANCED",
    waveType: "REEF_BREAK",
    swellSize: {
      min: 2.0,
    ...
    hazards: ["Extreme cold water", "Sharp reef", "Isolation", "Sharks"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
  ...
  },
  {
    ...
    countryId: "angola",
    regionId: "bengo",
    location: "Cabo Ledo South",
    distanceFromCT: 3200,
    optimalWindDirections: ["E", "SE", "NE"],
    optimalSwellDirections: {
      min: 180,
      max: 220,
      cardinal: "S-SW",
    ...
    bestSeasons: ["winter"],
    optimalTide: "LOW_TO_MID",
    description: "A highly secluded, sand-and-rock left-hand point break surrounded by dramatic cliffs, offering uncrowded rides of over 400 meters for surfers willing to navigate rugged 4x4 tracks.",
    difficulty: "INTERMEDIATE",
    waveType: "POINT_BREAK",
    swellSize: {
      min: 0.9,
    ...
    hazards: ["Rocks", "Remote location", "No facilities"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
  ...
  },
  {
    ...
    bestSeasons: ["summer"],
    optimalTide: "ALL",
    description: "A peaceful, lesser-known beach break that produces gentle, clean waves during the southeast monsoon (Kusi) wind season from June to September.",
    difficulty: "BEGINNER",
    waveType: "BEACH_BREAK",
    swellSize: {
      min: 0.5,
  ...
  },
  {
    ...
    bestSeasons: ["summer", "winter"],
    optimalTide: "MID",
    description: "A warm-water, sand-bottom beach break that serves as a tranquil surfing sanctuary shielded from the heavy open-ocean swells of the southern Indian Ocean.",
    difficulty: "BEGINNER",
    waveType: "BEACH_BREAK",
    swellSize: {
      min: 0.6,
  ...
  },
  {
    ...
    bestSeasons: ["winter"],
    optimalTide: "MID",
    description: "A hidden gem right-hand reef break that offers long, clean walls sheltered from the strong, persistent northeast trade winds that buffet the rest of the Cape Verde archipelago.",
    difficulty: "INTERMEDIATE",
    waveType: "REEF_BREAK",
    swellSize: {
      min: 0.8,
    ...
    hazards: ["Shallow reef", "Strong winds"],
    crimeLevel: "Low",
    sharkAttack: {
      hasAttack: false,
    },
