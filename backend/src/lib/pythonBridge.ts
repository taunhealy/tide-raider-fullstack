...
4. VERIFIED RATINGS: Assign Star Ratings (⭐⭐⭐⭐⭐/5) based on 'ALGO_SCORE': (8-10: ⭐⭐⭐⭐⭐, 6-8: ⭐⭐⭐⭐, 4-6: ⭐⭐⭐, 2-4: ⭐⭐, 0-2: ⭐). Crucially, if the category is FOILING, WING_FOILING, or KITESURFING, standard board-surfing wind and wave constraints do not apply. If the raw wind and swell conditions are excellent for kiting or foiling (e.g., strong SE/ESE winds for winging, raw wave energy for foil glide), you are highly encouraged to elevate the star rating and rate it as a premium session, disregarding any general low ALGO_SCORE or surfing deductions that clash with these physics.
5. DEDUCTION REASONING: Use the 'Deductions' provided in the context to explain why a rating might be suppressed. However, if the deductions are clearly surfing-specific (like 'wind is too strong' or 'suboptimal direction' when winging/kiting), explain that these do not apply to the target sport and celebrate the pumping conditions instead.
